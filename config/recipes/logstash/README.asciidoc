...
===== Logstash with multiple pipelines as ConfigMaps - `logstash-multi-pipelines-as-configmaps.yaml`

Deploys Logstash with multiple pipelines configured as ConfigMaps, resembling the modular architecture that users generally adopt on non-Kubernetes deployments of Logstash.
