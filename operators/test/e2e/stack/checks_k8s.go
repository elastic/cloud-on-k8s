...
func KibanaDoReq(stack Builder, method string, uri string, body []byte) ([]byte, error) {
	password, err := helpers.NewK8sClientOrFatal().GetElasticPassword(stack.Elasticsearch.Name)
	if err != nil {
		return nil, err
	}
