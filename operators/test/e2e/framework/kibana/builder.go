	...
	return Builder{
		Kibana: kbtype.Kibana{
			...
			Spec: kbtype.KibanaSpec{
				Version: framework.ElasticStackVersion,
				...
				PodTemplate: corev1.PodTemplateSpec{
					Spec: corev1.PodSpec{
						SecurityContext: framework.DefaultSecurityContext(),
					},
				},
			},
		},
...
func (b Builder) WithRestrictedSecurityContext() Builder {
	b.Kibana.Spec.PodTemplate.Spec.SecurityContext = framework.DefaultSecurityContext()
	return b
}
