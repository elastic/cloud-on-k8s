...
func (b Builder) CheckK8sTestSteps(k *framework.K8sClient) framework.TestStepList {
...
func CheckCertificateAuthority(b Builder, k *framework.K8sClient) framework.TestStep {
...
func CheckPodCertificates(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckESPodsRunning(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckESVersion(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckESPodsReady(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckClusterHealth(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckServices(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckServicesEndpoints(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckClusterUUID(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
...
func CheckESPassword(b Builder, k *framework.K8sClient) framework.TestStep {
	return framework.TestStep{
