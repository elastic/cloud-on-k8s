...
func CreateStorageClass(storageClass v1.StorageClass, k *framework.K8sClient) framework.TestStep {
...
func DefaultStorageClass(k *framework.K8sClient) (*v1.StorageClass, error) {
