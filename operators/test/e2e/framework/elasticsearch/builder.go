	...
	return Builder{
		Elasticsearch: estype.Elasticsearch{
			...
			Spec: estype.ElasticsearchSpec{
				SetVMMaxMapCount: framework.BoolPtr(false),
...
func (b Builder) WithRestrictedSecurityContext() Builder {
	b.Elasticsearch.Spec.SetVMMaxMapCount = framework.BoolPtr(false)
	for idx := range b.Elasticsearch.Spec.Nodes {
		node := &b.Elasticsearch.Spec.Nodes[idx]
		node.PodTemplate.Spec.SecurityContext = framework.DefaultSecurityContext()
	}
	return b
}
