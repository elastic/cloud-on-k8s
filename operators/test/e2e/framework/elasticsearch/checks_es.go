...
func (e *esClusterChecks) BuildESClient(es estype.Elasticsearch, k *framework.K8sClient) framework.TestStep {
...
func (e *esClusterChecks) CheckESReachable() framework.TestStep {
	return framework.TestStep{
...
func (e *esClusterChecks) CheckESVersion(es estype.Elasticsearch) framework.TestStep {
	return framework.TestStep{
...
func (e *esClusterChecks) CheckESHealthGreen() framework.TestStep {
	return framework.TestStep{
...
func (e *esClusterChecks) CheckESNodesTopology(es estype.Elasticsearch) framework.TestStep {
	return framework.TestStep{
