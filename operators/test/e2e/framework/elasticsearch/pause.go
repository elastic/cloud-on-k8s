...
func togglePauseOn(paused bool, es v1alpha1.Elasticsearch, k *framework.K8sClient) framework.TestStep {
...
func PauseReconciliation(es v1alpha1.Elasticsearch, k *framework.K8sClient) framework.TestStep {
	return togglePauseOn(true, es, k)
}

func ResumeReconciliation(es v1alpha1.Elasticsearch, k *framework.K8sClient) framework.TestStep {
