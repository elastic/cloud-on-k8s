...
type Client interface {
	...
	// UpdatePersistentSettings updates the persistent settings of a cluster.
	UpdatePersistentSettings(ctx context.Context, persistentSettings PersistentSettings) error
