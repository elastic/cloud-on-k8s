...
func (c *clientV6) StartTrialLicense(ctx context.Context) error {
	return c.post(ctx, "/_xpack/license/start_trial?acknowledge=true", nil, nil)
}

func (c *clientV6) StartBasicLicense(ctx context.Context) error {
	return c.post(ctx, "/_xpack/license/start_basic?acknowledge=true", nil, nil)
}
