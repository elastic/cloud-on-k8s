...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceNameReference) DeepCopyInto(out *ResourceNameReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceNameReference.
func (in *ResourceNameReference) DeepCopy() *ResourceNameReference {
	if in == nil {
		return nil
	}
	out := new(ResourceNameReference)
	in.DeepCopyInto(out)
	return out
}
