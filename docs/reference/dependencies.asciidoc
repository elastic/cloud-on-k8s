...
| link:https://github.com/google/go-containerregistry[$$github.com/google/go-containerregistry$$] | v0.8.0 | Apache-2.0
...
| link:https://cloud.google.com/go[$$cloud.google.com/go$$] | v0.100.2 | Apache-2.0
...
| link:https://golang.org/x/mod[$$golang.org/x/mod$$] | v0.5.1 | BSD-3-Clause
...
| link:https://golang.org/x/tools[$$golang.org/x/tools$$] | v0.1.8 | BSD-3-Clause
