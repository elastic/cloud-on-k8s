...
| link:https://github.com/elastic/go-ucfg[$$github.com/elastic/go-ucfg$$] | v0.8.7 | Apache-2.0
...
| link:https://github.com/hashicorp/vault[$$github.com/hashicorp/vault/api$$] | v1.12.0 | MPL-2.0
...
| link:https://github.com/prometheus/common[$$github.com/prometheus/common$$] | v0.49.0 | Apache-2.0
...
| link:https://golang.org/x/crypto[$$golang.org/x/crypto$$] | v0.21.0 | BSD-3-Clause
| link:https://gopkg.in/yaml.v3[$$gopkg.in/yaml.v3$$] | v3.0.1 | MIT
| link:https://github.com/kubernetes/api[$$k8s.io/api$$] | v0.29.2 | Apache-2.0
| link:https://github.com/kubernetes/apimachinery[$$k8s.io/apimachinery$$] | v0.29.2 | Apache-2.0
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.29.2 | Apache-2.0
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.21.0 | BSD-3-Clause
| link:https://golang.org/x/oauth2[$$golang.org/x/oauth2$$] | v0.17.0 | BSD-3-Clause
| link:https://golang.org/x/sync[$$golang.org/x/sync$$] | v0.5.0 | BSD-3-Clause
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.18.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.18.0 | BSD-3-Clause
