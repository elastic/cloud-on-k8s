...
| link:https://github.com/go-logr/logr[$$github.com/go-logr/logr$$] | v1.0.0 | Apache-2.0
...
| link:https://go.uber.org/zap[$$go.uber.org/zap$$] | v1.19.0 | MIT
...
| link:https://github.com/kubernetes/klog[$$k8s.io/klog/v2$$] | v2.20.0 | Apache-2.0
