...
| link:https://github.com/google/go-containerregistry[$$github.com/google/go-containerregistry$$] | v0.19.2 | Apache-2.0
...
| link:https://golang.org/x/crypto[$$golang.org/x/crypto$$] | v0.24.0 | BSD-3-Clause
...
| link:https://github.com/kubernetes/api[$$k8s.io/api$$] | v0.30.2 | Apache-2.0
| link:https://github.com/kubernetes/apimachinery[$$k8s.io/apimachinery$$] | v0.30.2 | Apache-2.0
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.30.2 | Apache-2.0
| link:https://github.com/kubernetes/klog[$$k8s.io/klog/v2$$] | v2.130.0 | Apache-2.0
...
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.21.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.21.0 | BSD-3-Clause
