...
| link:https://github.com/prometheus/common[$$github.com/prometheus/common$$] | v0.41.0 | Apache-2.0
...
| link:https://golang.org/x/mod[$$golang.org/x/mod$$] | v0.8.0 | BSD-3-Clause
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.8.0 | BSD-3-Clause
| link:https://golang.org/x/oauth2[$$golang.org/x/oauth2$$] | v0.5.0 | BSD-3-Clause
...
| link:https://golang.org/x/tools[$$golang.org/x/tools$$] | v0.6.0 | BSD-3-Clause
