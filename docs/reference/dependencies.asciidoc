...
| link:https://github.com/docker/docker[$$github.com/docker/docker$$] | v23.0.1+incompatible | Apache-2.0
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.8.0 | BSD-3-Clause
...
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.6.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.6.0 | BSD-3-Clause
