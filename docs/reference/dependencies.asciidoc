...
| link:https://github.com/docker/docker[$$github.com/docker/docker$$] | v26.0.1+incompatible | Apache-2.0
...
| link:https://go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp[$$go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp$$] | v0.44.0 | Apache-2.0
