...
| link:https://github.com/google/go-containerregistry[$$github.com/google/go-containerregistry$$] | v0.14.0 | Apache-2.0
...
| link:https://github.com/prometheus/client_golang[$$github.com/prometheus/client_golang$$] | v1.15.0 | Apache-2.0
...
| link:https://go.elastic.co/apm/module/apmelasticsearch/v2[$$go.elastic.co/apm/module/apmelasticsearch/v2$$] | v2.3.0 | Apache-2.0
| link:https://go.elastic.co/apm/module/apmhttp/v2[$$go.elastic.co/apm/module/apmhttp/v2$$] | v2.3.0 | Apache-2.0
| link:https://go.elastic.co/apm/module/apmzap/v2[$$go.elastic.co/apm/module/apmzap/v2$$] | v2.3.0 | Apache-2.0
| link:https://go.elastic.co/apm/v2[$$go.elastic.co/apm/v2$$] | v2.3.0 | Apache-2.0
...
| link:https://golang.org/x/crypto[$$golang.org/x/crypto$$] | v0.8.0 | BSD-3-Clause
...
| link:https://github.com/kubernetes/api[$$k8s.io/api$$] | v0.26.3 | Apache-2.0
| link:https://github.com/kubernetes/apimachinery[$$k8s.io/apimachinery$$] | v0.26.3 | Apache-2.0
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.26.3 | Apache-2.0
...
| link:https://sigs.k8s.io/controller-runtime[$$sigs.k8s.io/controller-runtime$$] | v0.14.6 | Apache-2.0
...
| link:https://github.com/docker/cli[$$github.com/docker/cli$$] | v23.0.1+incompatible | Apache-2.0
| link:https://github.com/docker/distribution[$$github.com/docker/distribution$$] | v2.8.1+incompatible | Apache-2.0
| link:https://github.com/docker/docker[$$github.com/docker/docker$$] | v23.0.3+incompatible | Apache-2.0
...
| link:https://github.com/klauspost/compress[$$github.com/klauspost/compress$$] | v1.16.0 | Apache-2.0
...
| link:https://golang.org/x/mod[$$golang.org/x/mod$$] | v0.9.0 | BSD-3-Clause
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.9.0 | BSD-3-Clause
| link:https://golang.org/x/oauth2[$$golang.org/x/oauth2$$] | v0.6.0 | BSD-3-Clause
| link:https://golang.org/x/sync[$$golang.org/x/sync$$] | v0.1.0 | BSD-3-Clause
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.7.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.7.0 | BSD-3-Clause
| link:https://golang.org/x/time[$$golang.org/x/time$$] | v0.3.0 | BSD-3-Clause
| link:https://golang.org/x/tools[$$golang.org/x/tools$$] | v0.7.0 | BSD-3-Clause
