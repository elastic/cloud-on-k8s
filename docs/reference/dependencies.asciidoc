...
| link:https://github.com/gkampitakis/go-snaps[$$github.com/gkampitakis/go-snaps$$] | v0.5.6 | MIT
...
| link:https://github.com/docker/docker[$$github.com/docker/docker$$] | v26.1.4+incompatible | Apache-2.0
