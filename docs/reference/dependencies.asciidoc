...
| link:https://github.com/prometheus/common[$$github.com/prometheus/common$$] | v0.39.0 | Apache-2.0
...
| link:https://golang.org/x/text[$$golang.org/x/text$$] | v0.5.0 | BSD-3-Clause
...
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.26.0 | Apache-2.0
| link:https://github.com/kubernetes/klog[$$k8s.io/klog/v2$$] | v2.80.1 | Apache-2.0
| link:https://github.com/kubernetes/utils[$$k8s.io/utils$$] | v0.0.0-20221107191617-1a15be271d1d | Apache-2.0
| link:https://sigs.k8s.io/controller-runtime[$$sigs.k8s.io/controller-runtime$$] | v0.13.1 | Apache-2.0
| link:https://sigs.k8s.io/controller-tools[$$sigs.k8s.io/controller-tools$$] | v0.11.1 | Apache-2.0
|===
...
| link:https://github.com/onsi/ginkgo[$$github.com/onsi/ginkgo/v2$$] | v2.4.0 | MIT
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.4.0 | BSD-3-Clause
...
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.3.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.3.0 | BSD-3-Clause
...
| link:https://github.com/kubernetes/component-base[$$k8s.io/component-base$$] | v0.26.0 | Apache-2.0
