...
| link:https://golang.org/x/crypto[$$golang.org/x/crypto$$] | v0.15.0 | BSD-3-Clause
...
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.14.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.14.0 | BSD-3-Clause
