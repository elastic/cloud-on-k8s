...
| link:https://github.com/prometheus/client_golang[$$github.com/prometheus/client_golang$$] | v1.20.2 | Apache-2.0
...
| link:https://sigs.k8s.io/controller-tools[$$sigs.k8s.io/controller-tools$$] | v0.16.3 | Apache-2.0
|===
