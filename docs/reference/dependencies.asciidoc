...
| link:https://github.com/elastic/go-elasticsearch[$$github.com/elastic/go-elasticsearch/v7$$] | v7.17.7 | Apache-2.0
...
| link:https://github.com/hashicorp/vault[$$github.com/hashicorp/vault/api$$] | v1.8.1 | MPL-2.0
...
| link:https://github.com/kubernetes/api[$$k8s.io/api$$] | v0.25.3 | Apache-2.0
| link:https://github.com/kubernetes/apimachinery[$$k8s.io/apimachinery$$] | v0.25.3 | Apache-2.0
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.25.3 | Apache-2.0
...
| link:https://cloud.google.com/go/compute[$$cloud.google.com/go/compute$$] | v1.10.0 | Apache-2.0
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.1.0 | BSD-3-Clause
...
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.1.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.1.0 | BSD-3-Clause
...
| link:https://google.golang.org/genproto[$$google.golang.org/genproto$$] | v0.0.0-20220915135415-7fd63a7952de | Apache-2.0
