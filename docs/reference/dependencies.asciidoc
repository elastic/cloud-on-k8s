...
| link:https://sigs.k8s.io/controller-runtime[$$sigs.k8s.io/controller-runtime$$] | v0.14.0 | Apache-2.0
...
| link:https://github.com/onsi/gomega[$$github.com/onsi/gomega$$] | v1.24.1 | MIT
...
| link:https://golang.org/x/tools[$$golang.org/x/tools$$] | v0.2.0 | BSD-3-Clause
