...
| *`autoscalingPolicies`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-config[$$Config$$]__ | AutoscalingPolicies holds the Autoscaling Policies settings (/_autoscaling/policy)
