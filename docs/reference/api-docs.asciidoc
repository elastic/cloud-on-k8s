...
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-autoscaling-v1alpha1-elasticsearchautoscalerlist[$$ElasticsearchAutoscalerList$$]
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-autoscaling-v1alpha1-elasticsearchautoscalerlist"]
...
| Field | Description
| *`apiVersion`* __string__ | `autoscaling.k8s.elastic.co/v1alpha1`
| *`kind`* __string__ | `ElasticsearchAutoscalerList`
...
| *`items`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-autoscaling-v1alpha1-elasticsearchautoscaler[$$ElasticsearchAutoscaler$$]__ | 
|===
...
| *`pollingPeriod`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#duration-v1-meta[$$Duration$$]__ | PollingPeriod is the period at which to synchronize and poll the Elasticsearch autoscaling API.
|===
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-clusterresources"]
=== ClusterResources 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetresources[$$NodeSetResources$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`name`* __string__ | Name is the name of the autoscaling policy to witch this resources belong to.
| *`nodeSets`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetnodecount[$$NodeSetNodeCount$$] array__ | NodeSetNodeCount holds the number of nodes for each nodeSet.
| *`NodeResources`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-noderesources[$$NodeResources$$]__ | NodeResources holds the resource values common to all the nodeSet managed by a same autoscaling policy.
|===
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-elasticsearchautoscalerstatus"]
=== ElasticsearchAutoscalerStatus 
...
|===
| Field | Description
| *`observedGeneration`* __integer__ | ObservedGeneration is the last observed generation by the controller.
| *`conditions`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-condition[$$Condition$$] array__ | Conditions holds the current service state of the autoscaling controller.
|===
...
NodeResources holds the resources to be used by each node managed by an autoscaling policy. All the nodes managed by an autoscaling policy have the same resources, even if they are in different NodeSets.

.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-clusterresources[$$ClusterResources$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`limits`* __object (keys:link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#resourcename-v1-core[$$ResourceName$$], values:Quantity)__ | 
| *`requests`* __object (keys:link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#resourcename-v1-core[$$ResourceName$$], values:Quantity)__ | 
|===
