...
- xref:{anchor_prefix}-elasticsearchconfig-k8s-elastic-co-v1alpha1[$$elasticsearchconfig.k8s.elastic.co/v1alpha1$$]
...
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-apm-v1-apmserverspec[$$ApmServerSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-beat-v1beta1-beatspec[$$BeatSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfigspec[$$ElasticsearchConfigSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-enterprisesearch-v1beta1-enterprisesearchspec[$$EnterpriseSearchSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-kibana-v1-kibanaspec[$$KibanaSpec$$]
...
[id="{anchor_prefix}-elasticsearchconfig-k8s-elastic-co-v1alpha1"]
== elasticsearchconfig.k8s.elastic.co/v1alpha1

Package v1alpha1 contains API schema definitions for managing Elasticsearch configuration resources.

.Resource Types
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfig[$$ElasticsearchConfig$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfiglist[$$ElasticsearchConfigList$$]



[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfig"]
=== ElasticsearchConfig 
...
|===
| Field | Description
| *`apiVersion`* __string__ | `elasticsearchconfig.k8s.elastic.co/v1alpha1`
| *`kind`* __string__ | `ElasticsearchConfig`
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#objectmeta-v1-meta[$$ObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.

| *`spec`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfigspec[$$ElasticsearchConfigSpec$$]__ | 
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfiglist"]
...
| Field | Description
| *`apiVersion`* __string__ | `elasticsearchconfig.k8s.elastic.co/v1alpha1`
| *`kind`* __string__ | `ElasticsearchConfigList`
...
| *`items`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfig[$$ElasticsearchConfig$$]__ | 
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfigoperation"]
=== ElasticsearchConfigOperation 
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfigspec"]
=== ElasticsearchConfigSpec 
...
|===
| Field | Description
| *`operations`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-esconfig-v1alpha1-elasticsearchconfigoperation[$$ElasticsearchConfigOperation$$] array__ | 
