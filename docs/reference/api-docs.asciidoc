...
| *`revisionHistoryLimit`* __integer__ | RevisionHistoryLimit sets the number of old DaemonSet to retain to allow rollback.
...
| Field | Description
| *`podTemplate`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#podtemplatespec-v1-core[$$PodTemplateSpec$$]__ | 
| *`revisionHistoryLimit`* __integer__ | RevisionHistoryLimit sets the number of old Deployment to retain to allow rollback.
...
| *`revisionHistoryLimit`* __integer__ | RevisionHistoryLimit sets the number of old StatefulSets to retain to allow rollback.
