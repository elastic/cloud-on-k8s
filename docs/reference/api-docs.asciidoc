...
| *`volumeClaimDeletePolicy`* __VolumeClaimDeletePolicy__ | VolumeClaimDeletePolicy sets the policy for handling deletion of PersistentVolumeClaims for all NodeSets. Defaults to RemoveOnScaleDownPolicy.
|===
