...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-namespacedsecretsource[$$NamespacedSecretSource$$]
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-namespacedsecretsource"]
...
|===
| Field | Description
| *`namespace`* __string__ | Namespace is the namespace of the secret.
...
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicylist[$$StackConfigPolicyList$$]
...
| Field | Description
| *`version`* __integer__ | 
| *`errors`* __string array__ | 
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-resourcepolicystatus"]
...
|===
| Field | Description
| *`phase`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-policyphase[$$PolicyPhase$$]__ | 
| *`currentVersion`* __integer__ | 
| *`expectedVersion`* __integer__ | 
| *`error`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-policystatuserror[$$PolicyStatusError$$]__ | 
|===
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicylist"]
=== StackConfigPolicyList 
...
| Field | Description
| *`apiVersion`* __string__ | `stackconfigpolicy.k8s.elastic.co/v1alpha1`
| *`kind`* __string__ | `StackConfigPolicyList`
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#listmeta-v1-meta[$$ListMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.

| *`items`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicy[$$StackConfigPolicy$$] array__ | 
|===
...
| *`secureSettings`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-namespacedsecretsource[$$NamespacedSecretSource$$] array__ | 
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicystatus"]
=== StackConfigPolicyStatus 
...
|===
| Field | Description
| *`resourcesStatuses`* __object (keys:string, values:xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-resourcepolicystatus[$$ResourcePolicyStatus$$])__ | ResourcesStatuses holds the status for each resource to be configured.
...
| *`phase`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-policyphase[$$PolicyPhase$$]__ | Phase is the phase of the StackConfigPolicy.
| *`observedGeneration`* __integer__ | ObservedGeneration is the most recent generation observed for this StackConfigPolicy.
|===
