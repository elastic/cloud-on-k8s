...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-agent-v1alpha1-agentstatus[$$AgentStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-apm-v1-apmserverstatus[$$ApmServerStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-apm-v1beta1-apmserverstatus[$$ApmServerStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-elasticsearchautoscalerstatus[$$ElasticsearchAutoscalerStatus$$]__ | 
|===
...
| *`policies`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingpolicyspecs[$$AutoscalingPolicySpecs$$]__ | 
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-beat-v1beta1-beatstatus[$$BeatStatus$$]__ | 
|===
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-deploymenthealth"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-apm-v1-apmserverstatus[$$ApmServerStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-deploymentstatus[$$DeploymentStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-enterprisesearch-v1-enterprisesearchstatus[$$EnterpriseSearchStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-enterprisesearch-v1beta1-enterprisesearchstatus[$$EnterpriseSearchStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-kibana-v1-kibanastatus[$$KibanaStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-maps-v1alpha1-mapsstatus[$$MapsStatus$$]
****



[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-deploymentstatus"]
=== DeploymentStatus 
...
|===
| Field | Description
| *`selector`* __string__ | Selector is the label selector used to find all pods.
| *`count`* __integer__ | Count corresponds to Scale.Status.Replicas, which is the actual number of observed instances of the scaled object.
| *`availableNodes`* __integer__ | AvailableNodes is the number of available replicas in the deployment.
...
| *`health`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-deploymenthealth[$$DeploymentHealth$$]__ | Health of the deployment.
|===
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-elasticsearchautoscalerstatus[$$ElasticsearchAutoscalerStatus$$]
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-countrange"]
=== CountRange 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingresources[$$AutoscalingResources$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`min`* __integer__ | Min represents the minimum number of nodes in a tier.
| *`max`* __integer__ | Max represents the maximum number of nodes in a tier.
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-decidersettings"]
=== DeciderSettings (object) 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingpolicy[$$AutoscalingPolicy$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingpolicyspec[$$AutoscalingPolicySpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-namedautoscalingpolicy[$$NamedAutoscalingPolicy$$]
****



[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-noderesources"]
=== NodeResources 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingpolicystatus[$$AutoscalingPolicyStatus$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`limits`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.27/#resourcelist-v1-core[$$ResourceList$$]__ | 
| *`requests`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.27/#resourcelist-v1-core[$$ResourceList$$]__ | 
|===




[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetnodecount"]
=== NodeSetNodeCount 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetnodecountlist[$$NodeSetNodeCountList$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`name`* __string__ | Name of the Nodeset.
| *`nodeCount`* __integer__ | NodeCount is the number of nodes, as computed by the autoscaler, expected in this NodeSet.
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetnodecountlist"]
=== NodeSetNodeCountList (xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-nodesetnodecount[$$NodeSetNodeCount$$]) 
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-policystate"]
=== PolicyState 
...
|===
| Field | Description
| *`type`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-autoscalingeventtype[$$AutoscalingEventType$$]__ | 
| *`messages`* __string array__ | 
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-quantityrange"]
=== QuantityRange 
...
|===
| Field | Description
| *`min`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-api-resource-quantity[$$Quantity$$]__ | Min represents the lower limit for the resources managed by the autoscaler.
| *`max`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-api-resource-quantity[$$Quantity$$]__ | Max represents the upper limit for the resources managed by the autoscaler.
| *`requestsToLimitsRatio`* __xref:{anchor_prefix}-k8s-io-apimachinery-pkg-api-resource-quantity[$$Quantity$$]__ | RequestsToLimitsRatio allows to customize Kubernetes resource Limit based on the Request.
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-resourcelistint64"]
=== ResourceListInt64 (ResourceName]int64) 

ResourceListInt64 is a set of (resource name, quantity) pairs.

.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1alpha1-noderesourcesint64[$$NodeResourcesInt64$$]
****
...
| *`monitoringAssociationStatus`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-associationstatusmap[$$AssociationStatusMap$$]__ | 
...
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-elasticsearch-v1-elasticsearchspec[$$ElasticsearchSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-elasticsearch-v1-nodesetlist[$$NodeSetList$$]
****
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-enterprisesearch-v1-enterprisesearchstatus[$$EnterpriseSearchStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-enterprisesearch-v1beta1-enterprisesearchstatus[$$EnterpriseSearchStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-kibana-v1-kibanastatus[$$KibanaStatus$$]__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-kibana-v1beta1-kibanastatus[$$KibanaStatus$$]__ | 
|===
...
| *`elasticsearchAssociationsStatus`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-associationstatusmap[$$AssociationStatusMap$$]__ | ElasticsearchAssociationStatus is the status of any auto-linking to Elasticsearch clusters.
| *`monitoringAssociationStatus`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-common-v1-associationstatusmap[$$AssociationStatusMap$$]__ | MonitoringAssociationStatus is the status of any auto-linking to monitoring Elasticsearch clusters.
| *`selector`* __string__ | 
|===
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-maps-v1alpha1-mapsstatus[$$MapsStatus$$]__ | 
|===
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-policyphase"]
=== PolicyPhase (string) 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-resourcepolicystatus[$$ResourcePolicyStatus$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicystatus[$$StackConfigPolicyStatus$$]
****



[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-policystatuserror"]
=== PolicyStatusError 
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-resourcetype"]
=== ResourceType (string) 
...
| *`status`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-v2-pkg-apis-stackconfigpolicy-v1alpha1-stackconfigpolicystatus[$$StackConfigPolicyStatus$$]__ | 
|===
