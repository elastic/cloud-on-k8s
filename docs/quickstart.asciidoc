...
* For this quickstart guide, your Kubernetes cluster is assumed to be already up and running, and conform to one of the link:k8s-quickstart.html[supported versions].
