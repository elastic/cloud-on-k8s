...
----
If you did not follow the instructions above and named your GCS credentials file differently, you can still map it to the expected name now. See link:k8s-es-secure-settings.html[Secure Settings] for details.
...
If you are running older versions of Elasticsearch, that don't have Snapshot Lifecycle Management, you can still set up a simple CronJob to take a snapshot every day.
