...
NOTE: You can initiate a trial license only if a trial has not previously been activated for the current major product version of your ECK installation.
