...
```
 admission webhook "elastic-es-validation-v1.k8s.elastic.co" denied the request: Elasticsearch.elasticsearch.k8s.elastic.co "quickstart" is invalid: "versions": Invalid value: "quickstart": json: unknown field "versions"
```
