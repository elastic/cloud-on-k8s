...
If validation webhook is preventing you from doing changes by the unknown fields validation, you can force the webhook to ignore it by removing `kubectl.kubernetes.io/last-applied-configuration` annotation from your resource.
