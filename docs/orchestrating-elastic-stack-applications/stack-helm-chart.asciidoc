...
helm install eck-stack-with-fleet elastic/eck-stack --values https://github.com/elastic/cloud-on-k8s/tree/main/deploy/eck-stack/examples/agent/fleet-agents.yaml -n elastic-stack
----
