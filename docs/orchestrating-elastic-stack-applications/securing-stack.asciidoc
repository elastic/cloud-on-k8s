...
You can use Elastic Stack configuration policy to configure the following authentication configurations:
...
include::security/ldap-using-stack-config-policy.asciidoc[leveloffset=+1]
include::security/oidc-stack-config-policy.asciidoc[leveloffset=+1]
include::security/jwt-stack-config-policy.asciidoc[leveloffset=+1]
