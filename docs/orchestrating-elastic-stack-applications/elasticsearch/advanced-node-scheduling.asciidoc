...
The following example demonstrates how to use the `topology.kubernetes.io/zone` node labels to spread a NodeSet among the availability zones of a Kubernetes cluster.
