...
+
This option allows you to verify the correctness of the image before rolling it out to your ECK installation.

. Install the plugins or configuration files at Pod startup time.
+
This option gives you maximum flexibility, but you can catch errors only at runtime. Also, plugin installation at runtime needs access to the Internet from your cluster
