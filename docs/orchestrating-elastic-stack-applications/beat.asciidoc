...
If you have configured a Beat to run as a `Deployment` and you are using a `hostPath` volumes as the Beats data directory, you might encounter an error similar to the following:
[source,shell script]
----
