...
For more ready-to-use manifest examples, please see <<{p}-beat-configuration-examples,Configuration Examples>>.
...
```yaml
kubectl apply -f https://raw.githubusercontent.com/elastic/cloud-on-k8s/1.2/config/recipes/beats/heartbeat_es_kb_heatlh.yaml
```
