...
- Specifying `kibanaRef` pointing to Kibana with TLS disabled will prevent the Beat and the APM Server from starting. See an link:https://github.com/elastic/cloud-on-k8s/issues/3523[issue] for more context.
