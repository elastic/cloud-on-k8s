...
ECK offers a convenient way to associate Elastic Stack resources together, but it requires them all to be managed by ECK in the same Kubernetes cluster.
