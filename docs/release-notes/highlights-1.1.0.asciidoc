...
<<{p}-kibana-scaling,Scaling Kibana>> is made easier with automatic provisioning of the encryption key. This also prevents existing sessions from being invalidated during a Kibana upgrade or a restart.
