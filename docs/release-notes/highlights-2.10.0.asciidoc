...
ECK 2.10.0 supports running Elastic Agent without running the Pod as the root user. (see https://github.com/elastic/cloud-on-k8s/tree/main/config/recipes/elastic-agent#system-and-kubernetes-integrations-running-as-non-root---fleet-kubernetes-integration-nonrootyaml[documentation]).
