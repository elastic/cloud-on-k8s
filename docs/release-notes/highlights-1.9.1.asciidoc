...
This release introduces a preemptive measure to mitigate [Log4Shell](https://github.com/advisories/GHSA-jfh8-c2jp-5v3q) vulnerability in Elasticsearch versions below `7.12`.
