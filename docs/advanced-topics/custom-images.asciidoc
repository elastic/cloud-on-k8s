...
If your custom images follow the naming convention adapted by the official images and you only want to use your custom images you can also simply <<{p}-container-registry-override, override the container registry>>.
