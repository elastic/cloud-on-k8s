...
Assuming that the Kubernetes API server IP address is `10.0.0.1`, the following network policy implements the set of permissions required for Egress and Ingress.
