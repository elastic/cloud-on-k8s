...
NOTE: If stack monitoring is configured for a Beat, but the cooresponding Elasticsearch cluster is not monitored, the Kibana Stack Monitoring page will not show the Beats data.
