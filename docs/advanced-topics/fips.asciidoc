...
[source,sh]
----
curl -s https://download.elastic.co/downloads/eck/${ECK_VERSION}/operator.yaml | sed 's/\(.*image:\).*$/\1 "docker.elastic.co\/eck\/eck-operator-fips:${ECK_VERSION}"/g' | kubectl apply -f -
----
