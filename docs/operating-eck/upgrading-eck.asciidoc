...
For production use, when you plan to upgrade ECK, it's important to recognize that, the overall time the upgrade takes is the time to upgrade the ECK operator plus the time to roll all managed workloads/Elasticserach clusters
================================
