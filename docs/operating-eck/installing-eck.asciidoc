...
NOTE: A shell script is available in the link:{eck_github}/blob/{eck_release_branch}/charts/eck-operator/helm-migrate.sh[ECK source repository] to demonstrate how to migrate from version 1.7.1 to Helm. You can modify it to suit your own environment.
