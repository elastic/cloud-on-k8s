...
- `eck.k8s.elastic.co/es-observer-request-timeout`: Request timeout for health checks. Must not exceed the Elasticsearch client timeout. Defaults to 1 minute.
