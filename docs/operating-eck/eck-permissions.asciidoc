...
|apiextensions.k8s.io|CustomResourceDefinition|yes|Preventing accidental CRD Deletion. Check link:https://www.elastic.co/guide/en/cloud-on-k8s/current/k8s-prevent-crd-deletion.html[docs] to learn more.
|===
