...
|apiextensions.k8s.io|CustomResourceDefinition|yes|Preventing accidental CRD Deletion. Check link:https://www.elastic.co/guide/en/cloud-on-k8s/current/k8s-webhook.html#k8s_enabling_the_crd_prevention_webhook[docs] to learn more.
|===
