...
****
- xref:apm-k8s-elastic-co-v1-apmserverspec[$$ApmServerSpec$$], 
- xref:elasticsearch-k8s-elastic-co-v1-k8slocalremotecluster[$$K8sLocalRemoteCluster$$], 
- xref:kibana-k8s-elastic-co-v1-kibanaspec[$$KibanaSpec$$]
****
[cols="20a,80a", options="header"]
|===
...
Can only be used if ECK is enforcing RBAC on references.
*`remoteClusters`* _xref:elasticsearch-k8s-elastic-co-v1-remoteclusters[$$RemoteClusters$$]_::
_(Optional)_
...
Can only be used if ECK is enforcing RBAC on references.
| *`remoteClusters`* +
_xref:elasticsearch-k8s-elastic-co-v1-remoteclusters[$$RemoteClusters$$]_
|
_(Optional)_
RemoteClusters enables you to establish uni-directional connections to a remote Elasticsearch cluster.
|===

[id="elasticsearch-k8s-elastic-co-v1-k8slocalremotecluster"]
[float]
...
.Appears in:
****
- xref:elasticsearch-k8s-elastic-co-v1-remoteclusters[$$RemoteClusters$$]
****
[cols="20a,80a", options="header"]
|===
|Field |Description
...
[id="elasticsearch-k8s-elastic-co-v1-remoteclusters"]
[float]
==== RemoteClusters
...
| *`k8sLocal`* +
_xref:elasticsearch-k8s-elastic-co-v1-k8slocalremotecluster[$$[]K8sLocalRemoteCluster$$]_
|
---
|===
