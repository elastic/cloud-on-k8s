...
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-apm-v1-apmserverspec[$$ApmServerSpec$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-k8slocalremotecluster[$$K8sLocalRemoteCluster$$]
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-kibana-v1-kibanaspec[$$KibanaSpec$$]
****
...
| *`remoteClusters`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-remoteclusters[$$RemoteClusters$$]__ | RemoteClusters enables you to establish uni-directional connections to a remote Elasticsearch cluster.
|===


[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-k8slocalremotecluster"]
==== K8sLocalRemoteCluster 



.Appears In:
****
- xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-remoteclusters[$$RemoteClusters$$]
****
...
[id="{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-remoteclusters"]
==== RemoteClusters 
...
|===
| Field | Description
| *`k8sLocal`* __xref:{anchor_prefix}-github-com-elastic-cloud-on-k8s-pkg-apis-elasticsearch-v1-k8slocalremotecluster[$$K8sLocalRemoteCluster$$] array__ | 
|===
