...
func (in *ChangeStrategy) DeepCopyInto(out *ChangeStrategy) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChangeStrategy.
func (in *ChangeStrategy) DeepCopy() *ChangeStrategy {
	if in == nil {
		return nil
	}
	out := new(ChangeStrategy)
	in.DeepCopyInto(out)
	return out
}
