...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this kibana.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by Kibana - change this for objects you create
...
func (r *ReconcileKibana) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &kibanav1alpha1.Kibana{}
