...
func TestVersionUpgradeToLatest7x(t *testing.T) {
	...
	test.RunMutationsWhileWatching(
		...
		[]test.Watcher{NewReadinessWatcher(opts...), test.NewVersionWatcher(label.KibanaVersionLabelName, opts...)},
	)
}
...
func TestVersionUpgradeAndRespecToLatest7x(t *testing.T) {
	...
	test.RunMutationsWhileWatching(
		...
		[]test.Watcher{w, test.NewVersionWatcher(label.KibanaVersionLabelName, opts...)},
	)
}
