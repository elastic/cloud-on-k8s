...
import (
	...
	"github.com/elastic/cloud-on-k8s/v2/pkg/controller/association/controller"
...
func TestKibanaStandalone(t *testing.T) {
	...
	esBuilder := elasticsearch.NewBuilder(name).
		WithESMasterDataNodes(1, elasticsearch.DefaultResources). // TODO .ds-metrics-fleet_server.agent_status-default index is created with a replica
