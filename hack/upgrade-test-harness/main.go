...
func main() {
	...
	cmd.Flags().UintVar(&opts.retryCount, "retry-count", 20, "Number of retries")
	cmd.Flags().DurationVar(&opts.retryDelay, "retry-delay", 15*time.Second, "Delay between retries")
