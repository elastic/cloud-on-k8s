    ...
    stages {
        ...
        stage("Run E2E tests") {
            steps {
                ...
                script {
                    env.SHELL_EXIT_CODE = sh(returnStatus: true, script: 'make -C .ci get-docker-creds get-monitoring-secrets get-test-license get-elastic-public-key TARGET=ci-e2e ci')
