...
func (in *Agent) DeepCopyInto(out *Agent) {
	*out = *in
	...
	if in.assocConfs != nil {
		...
		*out = make(map[int]*v1.AssociationConf, len(*in))
...
func (in *AgentStatus) DeepCopyInto(out *AgentStatus) {
	*out = *in
	if in.ElasticsearchAssociationStatusGroup != nil {
		in, out := &in.ElasticsearchAssociationStatusGroup, &out.ElasticsearchAssociationStatusGroup
		*out = make(v1.AssociationStatusGroup, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
