...
var (
	...
	defaultChecks = []func(*MapsServer) field.ErrorList{
...
var _ webhook.Validator = &MapsServer{}

func (m *MapsServer) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).
		For(m).
		Complete()
}

func (m *MapsServer) ValidateCreate() error {
	validationLog.V(1).Info("Validate create", "name", m.Name)
	return m.validate(nil)
}

func (m *MapsServer) ValidateDelete() error {
	validationLog.V(1).Info("Validate delete", "name", m.Name)
	return nil
}

func (m *MapsServer) ValidateUpdate(old runtime.Object) error {
	validationLog.V(1).Info("Validate update", "name", m.Name)
	oldObj, ok := old.(*MapsServer)
	if !ok {
		return errors.New("cannot cast old object to MapsServer type")
	}
...
func checkNoUnknownFields(k *MapsServer) field.ErrorList {
	return commonv1.NoUnknownFields(k, k.ObjectMeta)
}

func checkNameLength(k *MapsServer) field.ErrorList {
