...
func TestWebhook(t *testing.T) {
	...
	validator := &emsv1alpha1.MapsServer{}
...
func mkMaps(uid string) *emsv1alpha1.MapsServer {
	return &emsv1alpha1.MapsServer{
...
func serialize(t *testing.T, k *emsv1alpha1.MapsServer) []byte {
	t.Helper()
