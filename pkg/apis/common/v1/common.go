...
type ObjectSelector struct {
	...
	// If not specified and the referenced resource requires client authentication, ECK will auto-generate
	// a client certificate. This field cannot be used in combination with secretName and currently is effective
	// only for Elasticsearch association types (elasticsearchRef).
...
func (o ObjectSelector) WithDefaultNamespace(defaultNamespace string) ObjectSelector {
	...
	return ObjectSelector{
		...
		ClientCertificateSecretName: o.ClientCertificateSecretName,
	}
}
...
func (o ObjectSelector) IsValid() error {
	...
	if o.Name == "" && o.ClientCertificateSecretName != "" {
