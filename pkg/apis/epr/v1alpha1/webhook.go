...
var (
	...
	defaultChecks = []func(*ElasticPackageRegistry) field.ErrorList{
...
// Satisfies the webhook.Validator interface.
func (m *ElasticPackageRegistry) ValidateDelete() (admission.Warnings, error) {
...
// Satisfies the webhook.Validator interface.
func (m *ElasticPackageRegistry) ValidateUpdate(_ runtime.Object) (admission.Warnings, error) {
	validationLog.V(1).Info("Validate update", "name", m.Name)
	return m.validate()
}

// WebhookPath returns the HTTP path used by the validating webhook.
func (m *ElasticPackageRegistry) WebhookPath() string {
	return webhookPath
}
...
func checkNameLength(epr *ElasticPackageRegistry) field.ErrorList {
