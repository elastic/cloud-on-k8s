...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KibanaBackgroundTasks) DeepCopyInto(out *KibanaBackgroundTasks) {
	*out = *in
	if in.Count != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KibanaBackgroundTasks.
func (in *KibanaBackgroundTasks) DeepCopy() *KibanaBackgroundTasks {
	if in == nil {
		return nil
	}
	out := new(KibanaBackgroundTasks)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KibanaEPRAssociation) DeepCopyInto(out *KibanaEPRAssociation) {
	*out = *in
	if in.Kibana != nil {
		in, out := &in.Kibana, &out.Kibana
		*out = new(Kibana)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KibanaEPRAssociation.
func (in *KibanaEPRAssociation) DeepCopy() *KibanaEPRAssociation {
	if in == nil {
		return nil
	}
	out := new(KibanaEPRAssociation)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KibanaPoolStatus) DeepCopyInto(out *KibanaPoolStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KibanaPoolStatus.
func (in *KibanaPoolStatus) DeepCopy() *KibanaPoolStatus {
	if in == nil {
		return nil
	}
	out := new(KibanaPoolStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KibanaSpec) DeepCopyInto(out *KibanaSpec) {
	*out = *in
	...
	out.PackageRegistryRef = in.PackageRegistryRef
	...
	if in.BackgroundTasks != nil {
		in, out := &in.BackgroundTasks, &out.BackgroundTasks
		*out = new(KibanaBackgroundTasks)
		(*in).DeepCopyInto(*out)
	}
}
