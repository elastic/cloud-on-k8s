...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EsEsAssociation) DeepCopyInto(out *EsEsAssociation) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EsEsAssociation.
func (in *EsEsAssociation) DeepCopy() *EsEsAssociation {
	if in == nil {
		return nil
	}
	out := new(EsEsAssociation)
	in.DeepCopyInto(out)
	return out
}
