...
const (
	...
	fipsKeystorePasswordSuffix                   = "fips-keystore-password" //nolint:gosec // Resource name suffix, not a secret value.
...
// FIPSKeystorePasswordSecret returns the name of the Secret that stores the
// autogenerated FIPS keystore password for an Elasticsearch cluster.
func FIPSKeystorePasswordSecret(esName string) string {
	return ESNamer.Suffix(esName, fipsKeystorePasswordSuffix)
}
...
func PodDisruptionBudgetNameForRole(esName string, role string) string {
	...
	return ESNamer.Suffix(esName, defaultPodDisruptionBudget, role)
}
