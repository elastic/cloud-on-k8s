...
const (
	...
	keystorePasswordSuffix                       = "keystore-password"
...
// KeystorePasswordSecret returns the name of the Secret that stores the
// autogenerated keystore password for an Elasticsearch cluster.
func KeystorePasswordSecret(esName string) string {
	return ESNamer.Suffix(esName, keystorePasswordSuffix)
}
