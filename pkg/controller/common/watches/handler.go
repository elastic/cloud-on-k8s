...
type HandlerRegistration interface {
	...
	EventHandler() handler.TypedEventHandler[client.Object]
}
...
func (d *DynamicEnqueueRequest[T]) AddHandlers(handlers ...HandlerRegistration) error {
...
func (d *DynamicEnqueueRequest[T]) AddHandler(handler HandlerRegistration) error {
	d.mutex.Lock()
...
func (d *DynamicEnqueueRequest[T]) RemoveHandler(handler HandlerRegistration) {
