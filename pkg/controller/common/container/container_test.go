...
func TestImageRepository(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:    "Elastic agent UBI image before 9.x",
			image:   AgentImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/elastic-agent-ubi:8.99.99",
		},
		{
			name:    "Elastic agent image pre 9.x",
			image:   AgentImage,
			version: "8.99.99",
			suffix:  "",
			want:    testRegistry + "/beats/elastic-agent:8.99.99",
		},
		{
			name:    "Elastic agent UBI image since 9.x",
			image:   AgentImageSince9,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/elastic-agent/elastic-agent:9.0.0",
		},
		{
			name:    "Filebeat UBI image pre 9.x",
			image:   FilebeatImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/filebeat-ubi:8.99.99",
		},
		{
			name:    "Filebeat UBI image since 9.x",
			image:   FilebeatImage,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/filebeat:9.0.0",
		},
		{
			name:    "Auditbeat UBI image pre 9.x",
			image:   AuditbeatImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/auditbeat-ubi:8.99.99",
		},
		{
			name:    "Auditbeat UBI image since 9.x",
			image:   AuditbeatImage,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/auditbeat:9.0.0",
		},
		{
			name:    "Metricbeat UBI image pre 9.x",
			image:   MetricbeatImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/metricbeat-ubi:8.99.99",
		},
		{
			name:    "Metricbeat UBI image since 9.x",
			image:   MetricbeatImage,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/metricbeat:9.0.0",
		},
		{
			name:    "Packetbeat UBI image pre 9.x",
			image:   PacketbeatImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/packetbeat-ubi:8.99.99",
		},
		{
			name:    "Packetbeat UBI image since 9.x",
			image:   PacketbeatImage,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/packetbeat:9.0.0",
		},
		{
			name:    "Heartbeat UBI image pre 9.x",
			image:   HeartbeatImage,
			version: "8.99.99",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/heartbeat-ubi:8.99.99",
		},
		{
			name:    "Heartbeat UBI image since 9.x",
			image:   HeartbeatImage,
			version: "9.0.0",
			suffix:  "-ubi",
			want:    testRegistry + "/beats/heartbeat:9.0.0",
		},
		{
			name:    "Kibana image",
			image:   KibanaImage,
