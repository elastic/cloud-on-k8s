...
const (
	...
	// Earlier version of ECK used this as the trial identifier
...
// IsAutoGenerated returns true if this license has been generated by trial controller or is eligible to be turned into one.
func (l EnterpriseLicense) IsAutoGenerated() bool {
	return l.License.Issuer == AutogenLicenseIssuer || l.License.Issuer == ""
}
