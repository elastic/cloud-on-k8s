...
// ClusterBuilder is used to build resources associated with an Elasticsearch Cluster
...
// NewElasticsearchPodSpec creates a new PodSpec for an Elasticsearch instance in this cluster.
func (b *ClusterBuilder) NewElasticsearchPodSpec() corev1.PodSpec {
	// TODO: validate version?
	imageName := fmt.Sprintf("docker.elastic.co/elasticsearch/elasticsearch:%s", b.Version)
	if b.CustomImageName != "" {
		imageName = b.CustomImageName
	}
	...
	return corev1.PodSpec{
		Containers: []corev1.Container{{
			Env: []corev1.EnvVar{
				...
				{Name: "discovery.zen.ping.unicast.hosts", Value: b.DiscoveryServiceName},
				{Name: "cluster.name", Value: b.ClusterName},
				{Name: "discovery.zen.minimum_master_nodes", Value: strconv.Itoa(b.DiscoveryZenMinimumMasterNodes)},
...
// readinessProbeScript is the verbatim shell script that acts as a readiness probe
var readinessProbeScript = `
#!/usr/bin/env bash -e
