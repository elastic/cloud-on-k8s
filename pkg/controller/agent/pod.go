...
func certificatesDir(association commonv1.Association, associationIndex int) string {
	return fmt.Sprintf("/mnt/elastic-internal/%s-certs-%d", association.AssociationType(), associationIndex)
}
