...
func newReconciler[T client.Object](mgr manager.Manager, params operator.Parameters) *ReconcileLogstash[T] {
...
func addWatches[T client.Object](mgr manager.Manager, c controller.Controller, r *ReconcileLogstash[T]) error {
...
var _ reconcile.Reconciler = &ReconcileLogstash[client.Object]{}
...
func (r *ReconcileLogstash[T]) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
...
func (r *ReconcileLogstash[T]) doReconcile(ctx context.Context, logstash logstashv1alpha1.Logstash) (*reconciler.Results, logstashv1alpha1.LogstashStatus) {
...
func (r *ReconcileLogstash[T]) validate(ctx context.Context, logstash logstashv1alpha1.Logstash) error {
	defer tracing.Span(&ctx)()
...
func (r *ReconcileLogstash[T]) onDelete(ctx context.Context, obj types.NamespacedName) error {
