...
func RegisterWebhook(mgr ctrl.Manager, validateStorageClass bool, exposedNodeLabels commonnodelabels.NodeLabels, managedNamespaces []string, matcher *nsmatch.NamespaceMatcher) {
	inner := &validator{
