...
func NewMergedESConfig(
	...
	esConfigFromStackConfigPolicy commonv1.Config,
	...
	esCfgFromStackCfg, err := common.NewCanonicalConfigFrom(esConfigFromStackConfigPolicy.Data)
	if err != nil {
		return CanonicalConfig{}, err
	}
