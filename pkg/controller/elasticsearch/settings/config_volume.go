...
func ConfigSecret(es v1beta1.Elasticsearch, ssetName string, configData []byte) corev1.Secret {
...
func ReconcileConfig(client k8s.Client, es v1beta1.Elasticsearch, ssetName string, config CanonicalConfig) error {
