...
func TestReconcileElasticsearch_Reconcile(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// We reset InProgressOperations and Conditions as we don't want compare them here.
			actualES.Status.InProgressOperations = esv1.InProgressOperations{}
			actualES.Status.Conditions = nil
