...
func ReconcileOrRetrieveCA(
	...
	if err != nil {
		...
		driver.Recorder().Eventf(&es, nil, corev1.EventTypeWarning, events.EventReasonValidation, events.EventActionParseSecret, err.Error())
		return nil, err
	}
	...
	if err := certificates.ValidateCustomCA(ctx, ca); err != nil {
		...
		driver.Recorder().Eventf(&es, nil, corev1.EventTypeWarning, events.EventReasonValidation, events.EventActionValidation, validationErr.Error())
