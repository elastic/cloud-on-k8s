...
// ApplyPolicy replaces the SCP-managed settings state.
// cluster_secrets is owned exclusively by the ES controller and is preserved
// by updateState regardless of what policy is applied.
