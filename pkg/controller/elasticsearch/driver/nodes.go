...
func (d *defaultDriver) reconcileNodeSpecs(
	...
	actualStatefulSets, err := essset.RetrieveActualStatefulSets(d.Client, k8s.ExtractNamespacedName(&d.ES))
	if err != nil {
		return results.WithError(err)
	}
...
func (d *defaultDriver) isNodeSpecsReconciled(ctx context.Context, actualStatefulSets essset.StatefulSetList, client k8s.Client, result *reconciler.Results) bool {
