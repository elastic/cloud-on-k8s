...
// GetKeystoreParams is used to generate the init container that will load the secure settings into a keystore.
func GetKeystoreParams() keystore.InitContainerParameters {
