...
type State struct {
	...
	originalEnterpriseSearch *entv1beta1.EnterpriseSearch
}
...
func NewState(request reconcile.Request, ent *entv1beta1.EnterpriseSearch) State {
	return State{Request: request, EnterpriseSearch: ent, originalEnterpriseSearch: ent.DeepCopy()}
}
