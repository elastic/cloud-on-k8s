...
func configSecretVolume(ems emsv1alpha1.MapsServer) volume.SecretVolume {
	return volume.NewSecretVolume(name.Config(ems.Name), "config", ConfigMountPath, ConfigFilename, 0444)
}
...
func reconcileConfig(driver driver.Interface, ems emsv1alpha1.MapsServer, ipFamily corev1.IPFamily) (corev1.Secret, error) {
...
func newConfig(d driver.Interface, ems emsv1alpha1.MapsServer, ipFamily corev1.IPFamily) (*settings.CanonicalConfig, error) {
...
func tlsConfig(ems emsv1alpha1.MapsServer) *settings.CanonicalConfig {
...
func associationConfig(c k8s.Client, ems emsv1alpha1.MapsServer) (*settings.CanonicalConfig, error) {
	cfg := settings.NewCanonicalConfig()
