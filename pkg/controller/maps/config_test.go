...
func emsWithConfigRef(name string, cfg *commonv1.Config) v1alpha1.MapsServer {
	return v1alpha1.MapsServer{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "ems",
			Namespace: "ns",
		},
...
func emsWithAssociation(associationConf commonv1.AssociationConf) v1alpha1.MapsServer {
	ent := v1alpha1.MapsServer{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "ns",
			Name:      "ems",
		},
