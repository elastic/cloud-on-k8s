...
func TestStringSet_Diff(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "the difference of set and other is the set of all elements of set that are not in other",
			set:   StringSet{"a": {}, "b": {}, "c": {}},
			other: StringSet{"a": {}},
			want:  StringSet{"b": {}, "c": {}},
		},
		{
			name:  "the difference of set and other can be empty",
			set:   StringSet{"a": {}, "b": {}, "c": {}},
			other: StringSet{"a": {}, "b": {}, "c": {}},
			want:  StringSet{},
		},
	}
	for _, tt := range tests {
